...
const init = ()=>{
    ...
    (0, _formValidationJs.controlInputValue)(cardElements);
};
init();
...
const renderPage = ()=>{
    ...
    const startValidationButton = (0, _createElementsJs.createStartValidationButton)();
    const validationMessage = (0, _createElementsJs.createValidationMessage)();
    (0, _redom.mount)(formContainer, validationMessage);
    (0, _redom.mount)(formContainer, startValidationButton);
...
parcelHelpers.export(exports, "createStartValidationButton", ()=>createStartValidationButton);
parcelHelpers.export(exports, "createValidationMessage", ()=>createValidationMessage);
var _redom = require("redom");
const createTitle = ()=>{
...
const createBlockWithError = (className, text)=>{
    const blockWithError = (0, _redom.el)(`span.error-message-block.${className}`, text);
    return blockWithError;
};
const createStartValidationButton = ()=>{
    const button = (0, _redom.el)("button", "\u041E\u0442\u043F\u0440\u0430\u0432\u0438\u0442\u044C", {
        type: "submit",
        className: "button form__submit"
    });
    const fieldContainer = (0, _redom.el)("div.field-container", {
        style: "display: flex; justify-content: flex-end"
    }, button);
    return fieldContainer;
};
const createValidationMessage = ()=>{
    const blockWithMessage = (0, _redom.el)("h2.validation-message-block");
    const fieldContainer = (0, _redom.el)("div.field-container", {
...
const isValidCardNumber = (cardNumber)=>{
    ...
    if (!numberCardPattern.test(cardNumber)) return false;
    return true;
};
const isValidCVC = (securityCode)=>{
    const numberCardPattern = /^[0-9]{3}$/;
    if (!numberCardPattern.test(securityCode)) return false;
    return true;
};
...
const addErrorMessageBlock = (className, message, inputElement)=>{
    ...
    if (!errorMessageBlock) {
        const blockWithError = (0, _createElementsJs.createBlockWithError)(className, message);
...
const isValidInputDate = (inputExpirationDate)=>{
    ...
    if (!isValidExpirationDate) addErrorMessageBlock(className, "\u0412\u0432\u0435\u0434\u0438\u0442\u0435 \u043A\u043E\u0440\u0440\u0435\u043A\u0442\u043D\u0443\u044E \u0434\u0430\u0442\u0443", inputExpirationDate);
    else removeErrorMessageBlock(className);
};
...
const isValidInputName = (inputName)=>{
    ...
    if (!isValid) addErrorMessageBlock(className, "\u0412\u0432\u0435\u0434\u0438\u0442\u0435 \u043A\u043E\u0440\u0440\u0435\u043A\u0442\u043D\u043E\u0435 \u043F\u043E\u043B\u043D\u043E\u0435 \u0438\u043C\u044F", inputName);
    else removeErrorMessageBlock(className);
};
const isValidInputCardNumber = (inputCardNumber)=>{
    ...
    if (!isValid) addErrorMessageBlock(className, "\u0412\u0432\u0435\u0434\u0438\u0442\u0435 \u043A\u043E\u0440\u0440\u0435\u043A\u0442\u043D\u044B\u0439 \u043D\u043E\u043C\u0435\u0440 \u043A\u0430\u0440\u0442\u044B", inputCardNumber);
    else removeErrorMessageBlock(className);
};
const isValidInputSecurityCode = (inputSecurityCode)=>{
    ...
    if (!isValid) addErrorMessageBlock(className, "\u0412\u0432\u0435\u0434\u0438\u0442\u0435 \u043A\u043E\u0440\u0440\u0435\u043A\u0442\u043D\u044B\u0439 CVC", inputSecurityCode);
    else removeErrorMessageBlock(className);
};
const controlInputValue = ({ card\u0421ontainer, creditCard, formContainer, inputName, inputCardNumber, inputExpirationDate, inputSecurityCode, cardNumber, cardName, cardExpire, cardSecurity, nameBack })=>{
    ...
    inputCardNumber.addEventListener("blur", ()=>isValidInputCardNumber(inputCardNumber));
    inputExpirationDate.addEventListener("blur", ()=>isValidInputDate(inputExpirationDate));
    inputSecurityCode.addEventListener("blur", ()=>isValidInputSecurityCode(inputSecurityCode));
    ...
    startValidationButton.addEventListener("click", ()=>{
        ...
        if (isValidFullname && isValidCard && isValidCode && isValidExpiration) validationMessage.textContent = "\u0414\u0430\u043D\u043D\u044B\u0435 \u0432\u0430\u043B\u0438\u0434\u043D\u044B\u0435";
        else validationMessage.textContent = "\u0414\u0430\u043D\u043D\u044B\u0435 \u043D\u0435\u0432\u0430\u043B\u0438\u0434\u043D\u044B\u0435";
...
},{}]},["cygyY","2OpUZ"], "2OpUZ", "parcelRequire2b81")
